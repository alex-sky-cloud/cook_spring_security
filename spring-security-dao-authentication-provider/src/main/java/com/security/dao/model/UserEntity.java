...
public class UserEntity {
    ...
    private Set<Group> principleGroups = new HashSet<>();

    public void addUserGroups(Group group){
        principleGroups.add(group);
        group.getUsers().add(this);
    }

    public void removeUserGroups(Group group){
        principleGroups.remove(group);
    ...
    public Set<Group> getPrincipleGroups() {
        return principleGroups;
    }

    public void setPrincipleGroups(Set<Group> principleGroups) {
        this.principleGroups = principleGroups;
    }
}
